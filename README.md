# EncisoMath LMS v0.25.127

## v0.25.127 — Fotos de perfil de estudiantes
...
- Requiere ejecutar una vez `supabase/migrations/SUPABASE_PROFILE_AVATARS_v0.25.127.sql`.
...
## v0.25.108 — Progreso: FlowIn estable y sin reinicios
...
- El pequeño propulsor junto al motor también deja de usar una silueta triangular y se integra como una extensión corta y redondeada de la estela.
- No requiere SQL nuevo.
